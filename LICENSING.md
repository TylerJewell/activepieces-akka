...
[activepieces/activepieces](https://github.com/activepieces/activepieces) and recording what it does, not by translating its
source. See `../activepieces-port/specs/SPEC-001-activepieces.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for the
...
## The interface — MIT, as activepieces/activepieces licensed it

- `gui/`
- `src/main/resources/static-resources/`

That code was written by the activepieces/activepieces project, Copyright 2020-2024 Activepieces Inc, and is shipped
here **verbatim**, reused rather than rebuilt, per this harness's RENDERING.md R3. It
remains under the licence its authors chose, unmodified, in `LICENSE-activepieces` and beside
