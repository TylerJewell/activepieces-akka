...
import { useRunListStream } from '@/lib/akka-feed';
...
export const RunsTable = () => {
  ...
  // The table is fed by one open connection rather than re-asking while a run is
  // unfinished (RENDERING.md R1). `refetch` stays for the actions that ask for an
  // immediate redraw after a bulk operation; the stream is what keeps it current.
  const streamed = useRunListStream<SeekPage<FlowRun>>();
